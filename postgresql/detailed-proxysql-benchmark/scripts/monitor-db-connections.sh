...
usage() {
  ...
  echo ""
  echo "Arguments:"
  echo "  duration  - How long to monitor in seconds (default: 180)"
  echo ""
...
# Connection string
PSQL_CMD="psql postgresql://${DB_USER}:${DB_PASSWD}@${DB_HOST}:${DB_PORT}/${DB_NAME}"
